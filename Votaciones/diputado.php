...
<head>
    ...
    <title>Diputado</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
<img class="fullscreen-image" src="imagenes/diputado.jpg" alt="Imagen a pantalla completa">

<div class="titulo">
    <label for="">Votar por Diputado</label>
</div>
...
<div class="botonAl">
        <button id="redirect-button" class="redirect-button" disabled onclick="redirectToAlcalde()">Finalizar Votacion</button>
    </div>
<script>
    ...
    function vote(button) {
        ...
        fetch('registrar_voto_diputado.php', {
            method: 'POST',
