...
<body>
<img class="fullscreen-image" src="imagenes/alcalde.jpg" alt="Imagen a pantalla completa">

<div class="titulo">
    <label for="">Votar por Alcalde</label>
</div>
...
<div class="botonAl">
        <button id="redirect-button" class="redirect-button" disabled onclick="redirectToAlcalde()">Votar Diputado</button>
    </div>
<script>
    ...
    function vote(button) {
        ...
        // Envia una solicitud al servidor para registrar el voto
        fetch('registrar_voto_alcalde.php', {
            method: 'POST',
    ...
    function redirectToAlcalde() {
            window.location.href = "diputado.php";
        }
</script>
</body>
</html>
